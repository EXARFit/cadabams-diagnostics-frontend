  ...
  return (
    <div className={styles.container}>
      ...
      >
        ...
        <span className={styles.whatsappTooltip}>+91 81239 54336</span>
      </a>
      {/* Enhanced Floating Call Button */}
      <a href="tel:8123954336" className={styles.floatingCall}>
        ...
        <span className={styles.callTooltip}>81239 54336</span>
      </a>
      <MobileCartSummary />
    </div>
  );
