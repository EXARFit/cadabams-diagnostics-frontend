  ...
  return (
    <div className={styles.container}>
      ...
      <a 
        ...
        className={`${styles.floatingCall} ${styles.floatingWhatsapp}`}
      >
        <div className={`${styles.callIcon} ${styles.whatsappIcon}`}>
        ...
        <span className={styles.callTooltip}>+91 80503 81444</span>
      </a>
